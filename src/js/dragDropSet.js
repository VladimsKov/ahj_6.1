...
export default function dragDropSet(container, addBtns) {
  ...
  container.addEventListener('mouseup', (evt) => {
    ...
    if (!evt.target.classList.contains('card')) {
      let topBorder = window.scrollY + inputFieldCoords.top;
      let bottomBorder = window.scrollY + inputFieldCoords.bottom;
      let leftBorder = window.scrollX + inputFieldCoords.left;
      let rightBorder = window.scrollX + inputFieldCoords.right;
